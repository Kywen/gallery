...
<head>
    ...
    <style type="text/css">
        ...
        #button {
            width: 133px;
            height: 133px;
            background-image: url('/gallery/Public/img/play.png');
            position: absolute;
            z-index: 1000;
            margin-left: -66px;
            left: 50%;
...
<div data-role="page">
    <div data-role="header" data-position="fixed">
        <h1 style="font-size: 40px">拼图</h1>
        <a href="../Welcome/cover.html" class="a_btn" id ='backBtn' style="font-size: 30px">返回</a>
    </div>
    <div data-role="main">
        <div id="vvg">
            <p id="desTip" style="font-size: 105px">第<span id="step">1</span>关</p>
            <div id="vvgBox" class="animated bounceIn">
                <ul id="gameCanvas"></ul>
            </div>
        </div>
    </div>
    ...
    function tipNextStep() {
        ...
        if (vvg.step < 15) {
            playBtn.onclick = function () {
                ...
                makeGame('http://139.199.198.151:8000/img/gallery/photo/img/' + vvg.step + '.large.jpg');
            }
        }
        else{
            var desTip = getId('desTip');
            desTip.innerHTML = '恭喜你，通关成功！';
        }
    }
}

// 默认播放第一关
makeGame('http://139.199.198.151:8000/img/gallery/photo/img/1.large.jpg');
